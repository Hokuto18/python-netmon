...
# ENUM: use class name and enum, witch has 'name' and 'value' attributes
...
for index in range(20):
    ...
    # USING LITERALS: RANDOM VENDOR FROM CHOICE, JUNIPER, ARISTA
    ...
    # if device["vendor"] == CISCO:
    #     device["os"] = choice(["ios", "iosxe", "iosxr", "nexus"])
    #     device["version"] = choice(["12.1(T)", "14.07X", "8.12(S).010"])
    # elif device["vendor"] == JUNIPER:
    #     device["os"] = "junos"
    ...
    # USING CLASS: RANDOM VENDOR FROM CHOICE OF CISCO OF CISCO, JUNIPER, ARISTA
