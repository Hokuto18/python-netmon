...
print("  _____      ______  _____   ___________    ___________")
...
print("\n----- Create table of non-compliant device OS versions for each vendor:os -------")
...
if devices2 == devices:
    print("\n    Assignment and modification: device2 STILL equals")
...
devices2[0]["name"] = "this is ANOTHER dump device name"
if devices2 == devices:
    print("     Huh?")
else:
    print("\n   Deep copy and modification: devices2 no longer equals devices")
    print("\n  ---> Moral: 'deepcopy()' gives you a complete copy of the original")
    print("\n  ---> Result: I can do whatever I want with my copy, without touching")
...
if new_set_of_devices == devices:
    ...
    print("     ---> Moral: you can compare any two data structures, no matter how")

print("\n\n------ Comparisons fo implementing SLAs ----------------------\n")
SLA_AVAILABILITY = 96
...
print("\n   Comoparison with an __eq__ method to handle evaluation")
if d1 == d1_equal:
...
if d1 == d1_same:
    print(f"    ----> with no __eq__ : success: {d1} points to same object instance")
else:
    print(f"    !!! with no __eq__ : oops, didn't expect this")