...
# COMPARE INVENTORY WE READ, WITH ORIGINAL INVENTORY, TO MAKE SURE THEY ARE EQUIVALENTS
...
if saved_inventory == inventory:
    ...
    print("-- failed: saved inventory different form original")

# READ THE ALT-FOMATTED YAML FILE
with open("l_00_inventory.yaml", "r") as yaml_in:
...
if saved_inventory_alt == inventory:
    ...
    print("-- failed: saved alt-formatted inventory differnt from original")
