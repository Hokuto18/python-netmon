from util.create_utils import create_devices_tuple, create_devices
...
if __name__ == '__main__':
    ...
    devices = create_devices_tuple(num_devices=4, num_subnets=1)

    print("\n----- LIST OF DEVICES --------------------")
    pprint(devices)

    print("\n----- DEVICE AS TUPLE --------------------")
    device = ("sbx-n9kv-ao", "cisco", "Nexus9000 c9300v", "nxos", "10.0.1.1")
    ...
    device = Device("sbx-n9kv-ao", "cisco", "Nexus900 C9399v Chassis", "nxos", "10.0.1.1")
