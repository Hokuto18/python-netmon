...
re_ip_address = (
    r"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|250[0-5])\.){3}"
    + r"([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|250[0-5])$"
)
re_hostname = (
    r"^(([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9])\.)*"
    + r"([A-Za-z0-9]|[A-Za-z0-9][A-Za-z09\-]*[A-Za-z0-9])$"
)
re_email = (
    r"^[a-z-A-z0-9.!#$%&'*+/=?^_`{|}~-]+"
    + r"@[a-z-A-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:.\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$"
)
